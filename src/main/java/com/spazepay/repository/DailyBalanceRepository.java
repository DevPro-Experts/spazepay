...
public interface DailyBalanceRepository extends JpaRepository<DailyBalance, Long> {
    ...
    Optional<DailyBalance> findByPlanIdAndDate(Long planId, LocalDate date);
    ...
    // You might add other query methods as needed, e.g., to retrieve daily balances for a plan within a date range
